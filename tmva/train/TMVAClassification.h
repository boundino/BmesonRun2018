...
namespace mytmva
{
  ...
  std::vector<mytmva::tmvavar> varlist = {
    ...
    mytmva::tmvavar("costheta"   , "TMath::Cos(Bdtheta)"                                                                            , "FMax"), // 5
    mytmva::tmvavar("dls3D"      , "TMath::Abs(BsvpvDistance/BsvpvDisErr)"                                                          , "FMax"), // 6
    mytmva::tmvavar("dls2D"      , "TMath::Abs(BsvpvDistance_2D/BsvpvDisErr_2D)"                                                    , "FMax"), // 7
    mytmva::tmvavar("trk1pt"     , "Btrk1Pt"                                                                                        , "FMax"), // 8
    mytmva::tmvavar("trk2pt"     , "Btrk2Pt"                                                                                        , "FMax"), // 9
    mytmva::tmvavar("ptimbalance", "TMath::Abs((Btrk1Pt-Btrk2Pt) / (Btrk1Pt+Btrk2Pt))"                                              , "FMax"), // 10
  };
